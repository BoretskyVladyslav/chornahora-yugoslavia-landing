...
Pages are created once on theme activation (`after_switch_theme` in `functions.php`). Skip insert if the slug already exists; always re-apply the static front page options.
